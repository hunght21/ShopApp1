...
import com.example.shopapp.activity.DetaileActivity;
...
public class PopularProductsAdapter extends RecyclerView.Adapter<PopularProductsAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.all_itemsp_image);
            name = itemView.findViewById(R.id.all_new_product_name);
            price = itemView.findViewById(R.id.all_itemsp_gia);
        }
    }
}
